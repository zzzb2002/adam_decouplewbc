...
def make_decouplewbc_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  actor_terms = {
    ...
    "command": ObservationTermCfg(
      ...
      params={"command_name": "decouplewbc"},
    ),
  ...
  commands: dict[str, CommandTermCfg] = {
    "decouplewbc": UniformDecouplewbcCommandCfg(
      entity_name="robot",
      ...
      min_height_for_velocity=0.735,
      heading_command=True,
      heading_control_stiffness=0.5,
      debug_vis=True,
      ranges=UniformDecouplewbcCommandCfg.Ranges(
        lin_vel_x=(-1.0, 1.0),
        lin_vel_y=(-1.0, 1.0),
        ang_vel_z=(-0.5, 0.5),
        heading=(-math.pi, math.pi),
        target_height=(-0.3, 0.0),
  ...
  rewards = {
    "track_linear_velocity": RewardTermCfg(
      ...
      weight=1.5,
      params={"command_name": "decouplewbc", "std": math.sqrt(0.25)},
    ),
    "track_angular_velocity": RewardTermCfg(
      func=mdp.track_angular_velocity,
      weight=1.0,
      params={"command_name": "decouplewbc", "std": math.sqrt(0.5)},
    ),
    "target_height": RewardTermCfg(
    ...
    "joint_vel_l2": RewardTermCfg(func=envs_mdp.joint_vel_l2, weight=-1.0e-4),
