...
from mjlab.asset_zoo.robots import (
  ADAM_PRO_23DOF_ACTION_SCALE,
  get_adam_pro_23dof_robot_cfg,
)
...
def adam_pro_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.scene.entities = {"robot": get_adam_pro_23dof_robot_cfg()}
  ...
  # - Waist roll/pitch stay tight to keep the torso upright.
