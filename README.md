...
python src/mjlab/scripts/csv_to_npz.py --input-file src/assets/motions/adam_sp/EricCamper04_stageii.csv --output-name EricCamper04_stageii.npz --input-fps 30 --output-fps 50 --robot adam_sp

python src/mjlab/scripts/train.py Mjlab-Tracking-Flat-Adam-Sp-No-State-Estimation --env.commands.motion.motion-file=src/assets/motions/adam_sp/EricCamper04_stageii.npz --env.scene.num-envs=4096 --gpu-ids [1]

python src/mjlab/scripts/play.py Mjlab-Tracking-Flat-Adam-Sp-No-State-Estimation --motion-file=src/assets/motions/adam_sp/EricCamper04_stageii.npz --checkpoint_file=logs/rsl_rl/adam_sp_tracking/2026-04-29_17-51-16/model_0.pt
